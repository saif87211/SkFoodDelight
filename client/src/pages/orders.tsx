                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3 mb-4">
                      ...
                      >
                        <img
                          src={
                            ...
                            "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?ixlib=rb-4.0.3&auto=format&fit=crop&w=60&h=60"
                          }
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p
                            className="text-gray-600 text-sm"
                            data-testid={`order-item-details-${item.id}`}
                          >
                    ...
                    {order.orderItems.length > 3 && (
                      <p
                        ...
                        data-testid={`order-more-items-${order.id}`}
                      >
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div className="space-y-1">
                      ...
                      <p
                        className="text-dark text-sm truncate max-w-xs"
